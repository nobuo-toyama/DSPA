...
fit_lm1 <- glm(ever.sz ~ surgery + worst.gcs + factor(sex) + age, data.frames1$`chain:1`, family = "binomial")
summary(fit_lm1)
display(fit_lm1)
```
```{r}
...
library("rvest")	
wiki_url <- read_html("https://wiki.socr.umich.edu/index.php/SOCR_Data_021708_Earthquakes")	
