---
title: "10 Neural Networks and SVMs"
author: "nobuo"
date: "2021/4/25"
...
x <- runif(1000, -10, 10)	
y <- ifelse(x>=0, 1, 0)	
plot(x, y, t="n", xlab = "Sum of input signals", 
     ylab = "Output signal", main = "Threshold Activation (th=0.0)")	
...
y <- 1/(1+exp(-x))	
plot(x, y, xlab = "Sum of input signals", 
     ylab = "Output signal", main = "Sigmoid Activation (th1=0; th2=2)")	
